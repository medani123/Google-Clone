...
export default function Home() {
  ...
  return (
    <div className='flex flex-col items-center justify-center h-screen '>
      ...
      <header className='flex w-full p-5 justify-between text-sm text-gray-700 font-bold'>
        {/* left section */}
        ...
        <div className='flex space-x-4 items-center'>
          ...
          {/* Avatar */}
          <Avatar url='https://cdn.iconscout.com/icon/free/png-256/avatar-366-456318.png' />
        </div>
      </header>
