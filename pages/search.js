...
export async function getServerSideProps(context) {
  ...
  // after server side render , pass result to client
  return {
    props: {
      results: data,
    },
